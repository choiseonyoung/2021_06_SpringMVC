...
public class HomeController {
	...
	// 주소창에 직접 입력하고 Enter를 눌렀을 때 ( : http://localhost:8080/rootPath/dumy/gallery/detail
...
//		model.addAttribute("file", fileName);
	...
	public String home(@RequestParam("one_file") MultipartFile one_file, MultipartHttpServletRequest m_file) {
		...
		// m_file 이라는 이름으로 전송된 파일의 전체 사이즈
		// m_file 부분 : 위에 RequestParam 이름, 그리고 home.jsp에 input의 name과 일치해야함
		 ...
		 * 
		 * 이 때 getFiles() 에는 form에서 설정된 input tag의 name 값을 지정해준다
