...
public class PageServiceImplV1 implements PageService {
	...
	public PageDTO makePagination(int totalListSize, int currentPage) {
		...
		// 마지막 페이지 개수가 listPerPage보다 작으면 마지막 페이지는 무시하는 totalPages 값이 계산된다
		...
		// 데이터를 자르기 위한 변수생성
		// 몇번데이터부터 몇번째까지를 자를지 선택하기
		// 전체 데이터가 685개라고 가정핳면
		// 마지막 페이지를 표현하기 위한 offset limit은
		// offset : 680
		// limit : 5가 되어야 하는데 아래 연산에서 limit 590이 돼버린다
