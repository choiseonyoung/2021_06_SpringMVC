...
/*
 * NaverBookServiceVImplV1 에서는 NaverAbstractService를 상속받았고
 * NaverBookServiceVImplV2 에서는 NaverBookServiceImplV1을 상속받았다
 * 
 ...
 * 
 * 따라서
 * NaverBookServiceImplV2 클래스에는 queryURL(), jsonString(), getNaverList() method가 모두 있는 것과 같다.
 */
@Slf4j
